...
- **Top level** — live reference inputs. The current canonical direction doc lives here (`north-star-2026-04.md` at time of writing) alongside per-concern reference files (`best-practices.md`, `competitive-landscape.md`, `technical-stack.md`, `security-architecture.md`, `*-readiness.md`, `improvement-ideas.md`, `OpenPinceryAgent.tla`) and curated technical-source notes (`stonebraker-dbos-notes-2026-04.md`, `cloudflare-ai-infra-notes-2026-04.md`, `cloudflare-agents-sdk-notes-2026-04.md`, `genericagent-notes-2026-04.md`, `agent-harness-landscape-2026-04.md`).
- **`v6_pre_iterate/`** — pre-v6 synthesis drafts and raw source material preserved as provenance. Agents should read the top-level north star and curated notes as the source of truth; the `v6_pre_iterate/` files are context about _how_ we got there.
