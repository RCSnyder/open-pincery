...
32. **Slice G7 — AC-82 Fire reserved lifecycle states**: wire fine-grained `AgentStatus` variants into `src/runtime/wake.rs` CAS transitions + persist + emit `lifecycle_transition` + lifecycle-transition test. (3-4 days)
